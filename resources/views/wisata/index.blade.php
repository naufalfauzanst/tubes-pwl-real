...
<div class=" container">
    <div class=" bg-white my-5" style="border-radius: 20px;" >
        <br/>
			<p class="judul2 text-center">Wisata</p>
		<br/>
        <div class="row">
            <div class="col-8">        
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/324-gunung.jpg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=76"><h3 style="font-weight: bold; font-size: 25px;">Daftar 9 Tempat Wisata Salatiga, Cocok untuk Refreshing</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt">Salatiga</span></strong><span style="font-size:12.0pt">&nbsp;-Salatiga merupakan wilayah yang cukup strategis karena terletak di antara Semarang, Ambarawa, Magelang, dan Surakarta...</p>
                                    <a class="nav-item" href="konten.php?id_berita=76"><h6>Lanjut membaca</h6></a>
                                </div>                    
