...
<div class=" container">
    <div class=" bg-white my-5" style="border-radius: 20px;" >
        <br/>
			<p class="judul2 text-center">Bisnis</p>
		<br/>
        <div class="row">
            <div class="col-8">        
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/meikarta.jpeg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=63"><h3 style="font-weight: bold; font-size: 25px;">Apartemen Meikarta Masih Dijual Online, Segini Harganya</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt">Jakarta -</span></strong><span style="font-size:12.0pt"> Di tengah gonjang ganjing apartemen Meikarta yang diamuk konsumen, ternyata masih ada yang menjual unit barunya di situs j...</p>
                                    <a class="nav-item" href="konten.php?id_berita=63"><h6>Lanjut membaca</h6></a>
                                </div>                    
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/salon.jpg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                <div class="row">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=66"><h3 style="font-weight: bold; font-size: 25px;">Natal Jadi Berkat Bagi Bisnis Salon, Pengunjung Meningkat Dua Kali Lipat</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt"><span style="color:#333333">Medan -</span></span></strong><span style="font-size:12.0pt"><span style="color:#333333"> Menjelang perayaan hari Natal dan Tahun Baru 2023, pengunjung...</p>
                                    <a class="nav-item" href="konten.php?id_berita=66"><h6>Lanjut membaca</h6></a>
                                </div>                    
                                <div class="border-bottom my-2"></div>   
                            </div>
                        </div>
