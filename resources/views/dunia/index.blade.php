...
<div class=" container">
    <div class=" bg-white my-5" style="border-radius: 20px;" >
        <br/>
			<p class="judul2 text-center">Dunia</p>
		<br/>
        <div class="row">
            <div class="col-8">        
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/lesti.jpg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                <div class="row">
                                    <p style="color:black; font-weight:bold;"> Dunia </p> <p class="ml-2" style="color:black;"> 2022-12-13 </p>
                                </div>
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=60"><h3 style="font-weight: bold; font-size: 25px;">Lesti Laporkan Risky Billar ke Polisi Dugaan KDRT</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt">Leslar</span></strong><span style="font-size:12.0pt"> - Pedangdut Lesti Kejora melaporkan suaminya, Rizky Billar atas dugaan KDRT. Dalam laporaannya, Lesti mengaku dibanting dan d...</p>
                                    <a class="nav-item" href="konten.php?id_berita=60"><h6>Lanjut membaca</h6></a>
                                </div>                    
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/kaesang.jpeg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                <div class="row">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=61"><h3 style="font-weight: bold; font-size: 25px;">Megawati hingga SBY ikut Ramaikan Resepsi Pernikahan Kaesang-Erina</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt"><span style="color:black">Kaesang</span></span></strong><span style="font-size:12.0pt"><span style="color:black">&nbsp;- Tasyakuran pernikahan putra Presiden Jokowi, Kaesang Panga...</p>
                                    <a class="nav-item" href="konten.php?id_berita=61"><h6>Lanjut membaca</h6></a>
                                </div>                    
                                <div class="border-bottom my-2"></div>   
                            </div>
                        </div>
