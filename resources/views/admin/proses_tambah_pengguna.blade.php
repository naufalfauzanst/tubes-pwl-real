...
$kategori = $_POST['users'];

$pemeriksaan_kategori = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM users WHERE users='$_POST[users]'"));
    ...
    $sql = "INSERT INTO users (users) VALUES 
    ('$users')";

    if($koneksi->query($sql)===TRUE){
    echo "<h3 align = 'center' class='mt-4'>Berhasil</h3>";
    echo "<h4 align = 'center'>akun baru berhasil dibuat</h4>";
    echo "<p align = 'center'><a href = 'pengguna.php' class='btn btn-primary'  /> Kembali ke pengguna </a></p>";
    } else {
