...
<div class=" container">
    <div class=" bg-white my-5" style="border-radius: 20px;" >
        <br/>
			<p class="judul2 text-center">Kriminal</p>
		<br/>
        <div class="row">
            <div class="col-8">        
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/sambo.jpg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=62"><h3 style="font-weight: bold; font-size: 25px;">Richard Eliezer Berikan Pistol HS Milik Brigadir Yosua Ke FS Sebelum Pembunuhan</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt"><span style="color:black">Ferdy Sambo</span></span></strong><span style="font-size:12.0pt"><span style="color:black"> - Richard Eliezer Pudihang Lumiu sempat memberikan pistol HS ...</p>
                                    <a class="nav-item" href="konten.php?id_berita=62"><h6>Lanjut membaca</h6></a>
                                </div>                    
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-3 mt-2 mb-4 ml-2 zoom-effect">
                                <div class="kotak ml-3">
                                    <img src="{{asset('assets/img/berita/ganja.jpeg')}}" style="height: 120px;">
                                </div>
                            </div>
                            <div class="col-7 mt-2 ml-3">
                                <div class="row">
                                ...
                                <div class="row">
                                <a class="nav-item" href="konten.php?id_berita=64"><h3 style="font-weight: bold; font-size: 25px;">Polisi Tangkap Kurir Bawa 1,3 Ton Ganja di Medan</h3></a>
                                </div>
                                <div class="row">
                                    <p><p><span style="font-size:11pt"><strong><span style="font-size:12.0pt">Medan-</span></strong><span style="font-size:12.0pt"> Satuan Narkoba Polrestabes Medan menangkap seorang kurir narkotika inisial M (23) di dekat fly over, Jalan Jamin Ginting, Kot...</p>
                                    <a class="nav-item" href="konten.php?id_berita=64"><h6>Lanjut membaca</h6></a>
                                </div>                    
                                <div class="border-bottom my-2"></div>   
                            </div>
                        </div>
